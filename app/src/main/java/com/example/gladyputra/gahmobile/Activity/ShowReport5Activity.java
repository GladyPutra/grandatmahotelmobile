...
public class ShowReport5Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_report5);
        ...
        BarDataSet barDataSet = new BarDataSet(barEntries,"Bulan");
        ...
        String[] months = new String[] {"Januari","Februari","April","Oktober"};
        XAxis xAxis = barChart.getXAxis();
        xAxis.setValueFormatter(new ShowReport5Activity.MyAxisValueFormatter(months));
...
//        xAxis.setAxisMinimum(1);
    ...
    public void onClick(View view) {
        ...
        if(view == btn_detil)
        {
            ...
            startActivity(new Intent(this,Laporan4Activity.class));
        }
    }
}
