...
public class ShowReport3Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_report3);
        ...
        barEntries.add(new BarEntry(0,2200000f));
        barEntries.add(new BarEntry(1,5950000f));

        BarDataSet barDataSet = new BarDataSet(barEntries,"2018");
        ...
        String[] months = new String[] {"Bandung","Yogyakarta"};
...
//        xAxis.setAxisMinimum(1);
    ...
    public void onClick(View view) {
        ...
        if(view == btn_detil)
        {
            ...
            startActivity(new Intent(this,Laporan3Activity.class));
        }
    }
